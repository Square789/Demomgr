...
class THREADSIG(IntEnum):
	...
	CONNECTED = 0x100
	DELETION_SUCCESS = 0x101
	DELETION_FAILURE = 0x102
	EVENT_FILE_UPDATE_START = 0x103
	EVENT_FILE_UPDATE_MISSING = 0x104
	EVENT_FILE_UPDATE_ERROR = 0x105
	EVENT_FILE_UPDATE_SUCCESS = 0x106
	BOOKMARK_CONTAINER_UPDATE_START = 0x107
	BOOKMARK_CONTAINER_UPDATE_SUCCESS = 0x108
	BOOKMARK_CONTAINER_UPDATE_FAILURE = 0x109
