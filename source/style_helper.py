...
class StyleHelper():
	...
	def load_theme(self, themefilepath, themename):
		'''Loads tcl themefilepath defining a theme with
		...
		if not themename in existingthemes:
			filepath = os.path.join(os.path.normpath(os.getcwd()),
				os.path.normpath(themefilepath))
